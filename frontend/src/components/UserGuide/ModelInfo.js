// Documentation for the PES disease and travel model and data structures used in the backend code
// <ModelInfo /> is rendered in the accordion buttons of UserGuide.js
